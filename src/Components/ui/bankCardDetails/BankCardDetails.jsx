      ...
      {cards.map((item, index) => {
        return (
          <div
            ...
            className={inFull === index ? Style.selected : Style.notSelected}
          >
        ...
        formatter: (value) => {
          ...
          const stringWithSlash =
            limitedString.length >= 2
              ? limitedString.slice(0, 2) + " / " + limitedString.slice(2)
              : limitedString;
  ...
  return (
    <div className={Style.modalWrapper}>
      ...
      <div className={Style.inputsGrid}>
        ...
        <SimpleInput {...form.getInputProps("expiryDate")} label="Exp. Date" />
        <SimpleInput {...form.getInputProps("cvv")} icon label="CVV" />
        <SimpleInput {...form.getInputProps("name")} label="Name on Card" />
        {/* TODO : Add countries from the API with flags also */}
        <SimpleInput {...form.getInputProps("country")} label="Country" />
      </div>
      <CustomButton
        coloredReverse
